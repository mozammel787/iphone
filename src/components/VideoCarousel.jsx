        ...
        <>
                    ...
                    <div key={list.id} id="slider" className="sm:pr-20 pr-10">
                        <div className="video-carousel_container">
                            <div className="w-full h-full flex-center rounded-3xl overflow-hidden bg-black">
                                <video
                                    id="video"
                                    className={`${list.id == 2 && 'translat-x-44 object-left'} pointer-events-none object-cover h-full`}
                                    playsInline={true}
                                    preload="auto"
                                    muted
            ...
            <div className="relative flex-center mt-10">
                <div className="flex-center py-5 px-7 bg-gray-300 backdrop-blur rounded-full">
                    {videoRef.current.map((id, i) => (
                        <span
                            key={i}
                            ref={(e) => videoDivRef.current[i] = e}className="mx-2 w-3 h-3 bg-gray-200 rounded-full relative cursor-pointer">
                            <span
