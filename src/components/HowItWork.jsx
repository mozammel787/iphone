...
import { animateWithGsap } from '../utils/anemation';
                ...
                <div className='mt-10 md:mt-20 mb-14'>
                    ...
                    <div className='hiw-text-container'>
                        <div className='flex flex-1 justify-center flex-col'>
                            ...
                            A17 Pro is an entirely new class of iPhone chip that delivers our {' '}<span className='text-white'>best graphics performance by far</span>.<br/><br/> Mobile <span className='text-white'>games will look and feel so immersive</span>, with incredibly detailed environments and more realistic characters. And with industry-leading speed and efficiency, A17 Pro takes fast and runs with it.
                            </p>
                        </div>
                        <div className='flex-1 flex-center'>
                            <p className='hiw-text g_fadeIn'>
                            New <br /><span className='text-white text-5xl font-semibold'>lightest Pro models ever</span><br />with 6 cores
                            </p>
                        </div>
                    </div>
                </div>
